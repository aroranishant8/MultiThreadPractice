 ...
 * 
 */
@WebServiceClient(name = "HelloWorldService", targetNamespace = "http://webservices.javapostsforlearning.arpit.org", wsdlLocation = "http://localhost:8080/SImpleSoapExample/services/HelloWorld?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDSERVICE_QNAME = new QName("http://webservices.javapostsforlearning.arpit.org", "HelloWorldService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/SImpleSoapExample/services/HelloWorld?wsdl");
    ...
    public HelloWorld getHelloWorld() {
        return super.getPort(new QName("http://webservices.javapostsforlearning.arpit.org", "HelloWorld"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorld(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservices.javapostsforlearning.arpit.org", "HelloWorld"), HelloWorld.class, features);
    }
